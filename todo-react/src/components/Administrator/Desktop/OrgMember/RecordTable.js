    ...
    render() {
        ...
        const updateRecord = () => {
            ...
            || (middlename.length === 0)) {
                ...
                var port = TodoStore.getPort;
                var url = port+"memberrouter/update/"+id;
                ...
                axios.post(url, account)
                    .then(res => {
                        if (res.data === '404') {
                            ...
                            type="Success";
                            description="Member information successfully updated";
                            icontype="check";
                            colors="#73d13d";    
                            openNotification(type,description,icontype,colors);
                            TodoStore.setCancelModal(false);
        ...
        const newrecords = dataSource.filter(records => {
            ...
            }else if (TodoStore.filter === 'National Status') {
